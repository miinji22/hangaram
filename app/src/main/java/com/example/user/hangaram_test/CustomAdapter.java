...
public class CustomAdapter extends BaseAdapter {
    ...
    private ArrayList<com.example.user.hangaram.CustomDTO> listCustom = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.user.hangaram.CustomDTO dto = listCustom.get(position);
    ...
    public void addItem(com.example.user.hangaram.CustomDTO dto) {
        listCustom.add(dto);
    }
}